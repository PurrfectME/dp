...
public class MakeContributionResponseDto
{
    ...
    public class Attributes
    {
        ...
        [JsonPropertyName("contributor-email")]
        public string ContributorEmail { get; set; }

        [JsonPropertyName("contributor-name")]
        public string ContributorName { get; set; }

        [JsonPropertyName("created-at")]
        public DateTime CreatedAt { get; set; }

        [JsonPropertyName("funds-transfer-details")]
        public object FundsTransferDetails { get; set; }
    ...
    public class ContributionDrive
    {
        [JsonPropertyName("links")]
        public Links Links { get; set; }
    }
    ...
    public class Relationships
    {
        ...
        [JsonPropertyName("contribution-drive")]
        public ContributionDrive ContributionDrive { get; set; }
