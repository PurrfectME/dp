...
public sealed class RefundCapturedPaymentResponseDto
{
    /// <summary>
    ...
    internal static RefundCapturedPaymentResponseDto CreateFromModel(RefundCapturedPaymentResponse model)
    {
        if (model is null)
        {
            return null;
        ...
        return new RefundCapturedPaymentResponseDto
        {
