...
public sealed class AuthorizePaymentForOrderResponseDto
{
    /// <summary>
    ...
    internal static AuthorizePaymentForOrderResponseDto CreateFromModel(AuthorizePaymentForOrderResponse model)
    {
        if (model is null)
        {
            return null;
        ...
        return new AuthorizePaymentForOrderResponseDto
        {
