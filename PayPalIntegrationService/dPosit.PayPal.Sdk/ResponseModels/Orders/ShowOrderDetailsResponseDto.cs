...
public sealed class ShowOrderDetailsResponseDto
{
    /// <summary>
    ...
    internal static ShowOrderDetailsResponseDto CreateFromModel(ShowOrderDetailsResponse model)
    {
        if (model is null)
        {
            return null;
        ...
        return new ShowOrderDetailsResponseDto
        {
