...
public sealed class CapturePaymentForOrderResponseDto
{
    /// <summary>
    ...
    internal static CapturePaymentForOrderResponseDto CreateFromModel(CapturePaymentForOrderResponse model)
    {
        return new CapturePaymentForOrderResponseDto
        {
