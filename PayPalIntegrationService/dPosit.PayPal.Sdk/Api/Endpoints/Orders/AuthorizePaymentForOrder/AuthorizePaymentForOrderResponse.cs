...
internal sealed class AuthorizePaymentForOrderResponse
{
    /// <summary>
    ...
    /// capture payments on demand. This intent is not supported when you have more than one <c>purchase_unit</c> within your order.
    /// </value>
    ...
    /// "SAVED" - the order was saved and persisted. The order status continues to be in progress until a capture is made with final_capture = true for all purchase units within the order.<br/>
    /// "APPROVED" - the customer approved the payment through the PayPal wallet or another form of guest or unbranded payment. For example, a card, bank account, or so on.<br/>
